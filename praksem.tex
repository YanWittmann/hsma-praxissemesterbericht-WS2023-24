...
\usepackage{amsmath}
\usepackage{lstdoc}
%\usepackage{amstex} % now uses amsmath
...
\begin{document}
    ...
    \begin{abstract}
        ...
        Die Verbesserungen wurden sowohl in Kundenprojekte integriert, als auch als Beitrag zur Open-Source-Community veröffentlicht.
