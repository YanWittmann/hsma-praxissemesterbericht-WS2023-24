...
\begin{document}
    ...
    \fbox{
        \begin{minipage}{1\textwidth}
            ...
            Der vollständige Bericht ist alternativ auf Abfrage verfügbar.
        \end{minipage}
    }
    \fi
    ...
    \ifshortenedReport
    \include{wochenberichte/shortened/wochenberichte}
    \else
    \include{wochenberichte/initial/wochenberichte}
    \fi
