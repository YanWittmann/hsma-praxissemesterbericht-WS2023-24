...
Im CVE-System bekommt jede Schwachstelle eine eindeutige ID von der Form \qt{CVE-YYYY-NNNN} zugewiesen und wird nur als Schwachstelle bezeichnet, wenn sie ausgenutzt wird, die Konfidentialität, Integrität oder Verfügbarkeit negativ beeinflusst.
