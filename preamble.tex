...
% table of contents:
% vermeiden, dass die Kapitelnummerierung im Inhaltsverzeichnis zu weit nach rechts eingerückt ist und mit dem Kapitelnamen kollidiert
% MUSS VOR dem subfig package geladen werden (https://tex.stackexchange.com/questions/530946/extending-table-of-contents-dots-up-to-large-page-numbers)
\usepackage{tocloft}
\cftsetpnumwidth{2em} % Breite der Seitenzahlen im Inhaltsverzeichnis
\cftsetrmarg{3em} % Abstand der Seitenzahlen vom rechten Rand
...
\newcommand{\aeclientZEZESE}{[ein Kunde]}
